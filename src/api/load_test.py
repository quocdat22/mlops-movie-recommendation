...
class APILoadTester:
    ...
    def run_load_test(self, duration: int = 60, concurrent_users: int = 5):
        ...
        print(f"Starting load test for {duration} seconds with {concurrent_users} concurrent users...")
    ...
    def print_results(self, results: List[Dict], total_time: float):
        ...
        for endpoint in endpoint_stats:
            ...
            endpoint_stats[endpoint]['success_rate'] = endpoint_stats[endpoint]['success'] / total
