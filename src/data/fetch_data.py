        ...
        try:
            ...
            for movie in movies:
                ...
                if credits and 'cast' in credits:
                    movie['cast'] = [actor['name'] for actor in credits['cast']][:3] # Lấy 3 diễn viên đầu
                else:
                    movie['cast'] = []
            ...
            logging.info(f"Đã lấy, xử lý và lưu thành công dữ liệu từ trang {page}/{pages}.")
...
if __name__ == "__main__":
    ...
    if not tmdb_api_key:
        logging.error("Biến môi trường TMDB_API_KEY không được thiết lập. Vui lòng thêm vào file .env.")
    else:
